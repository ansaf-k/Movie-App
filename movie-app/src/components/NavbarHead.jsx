            ...
            <div className="flex items-center">
              ...
              <div className="hidden md:block">
                <div className="ml-10 flex items-baseline space-x-4">
                  ...
                  <a href="#" onClick={()=>handleCategory(popular)} className="text-gray-400 hover:text-white px-3 py-2 rounded-md text-sm font-medium transition duration-150 ease-in-out">Popular</a>
                  <a href="#" onClick={()=>handleCategory(latest)} className="text-gray-400 hover:text-white px-3 py-2 rounded-md text-sm font-medium transition duration-150 ease-in-out">Latest</a>
                </div>
              </div>
            </div>
            <div className="flex items-center">
